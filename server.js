...
const INITIAL_PRODUCTS = [
  ...
  { id: 's6', name: 'Balaric Sea Urchin Roe', name_zh: '顶级海胆黄 (Uni)', price: 110.00, description: 'Creamy, rich sea urchin roe that melts instantly in your mouth.', description_zh: '入口即化的奶油质地，带着深海的丰沛层次，是刺身界的黄金。', category: 'seafood', category_zh: '顶级海鲜', image: getLocalAI('sea_urchin_uni.png') },
